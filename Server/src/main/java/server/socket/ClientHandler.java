...
public class ClientHandler implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.out.println("Connection error with client " + clientToken + ": " + e.getMessage());
        } finally {
            closeConnection();
    ...
    private void sendWelcomeMessage() throws IOException {
        ...
        out.writeObject(new ServerResponse(ServerResponse.Status.INFO, "Welcome to the Booking Server"));
        out.flush();
    }
